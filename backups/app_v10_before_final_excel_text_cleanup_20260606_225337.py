...
def export_full_results_excel(params, Q_in_max):
    ...
    ws.append(["Note", "Optimization is selected using Schmidt; selected designs are validated by Adiabatic"])
    autofit(ws)
...
with tab_optimize:
    ...
    if has_optimization_results:
        st.caption(
            ...
            "NTU regenerator metrics, and Schmidt-vs-Adiabatic validation."
        )
