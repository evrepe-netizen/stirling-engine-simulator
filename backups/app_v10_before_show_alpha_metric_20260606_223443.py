...
with tab_optimize:
    ...
    with col_story:
        ...
        st.info(
            ...
            "Selected designs are then evaluated with the adiabatic model as a second-order reality check. "
    ...
    if stage_choice.startswith("Stage 2"):
        ...
        st.info(
            ...
            "The selected designs are then compared against the adiabatic model as a reality check."
        )
