...
with tab_optimize:
    ...
    # ── Stage 4 ───────────────────────────────────────────────────────────────
        ...
        st.markdown("### Balanced score")
        st.caption(
            "Stage 4 always returns three named designs for each gas: "
            "Max Power, Max Efficiency, and Balanced. "
            "This slider affects only the Balanced point."
        )
        w_P_s4 = st.slider(
        ...
        if 'stage4_results' in st.session_state:
            ...
            st.caption(
                ...
                "Air Prototype 2 is highlighted because some gas curves can overlap closely."
            )
            ...
            zorder_gas = {'Air': 6, 'Helium': 4, 'Hydrogen': 3}
            ...
            for gas_name in ['Air', 'Helium', 'Hydrogen']:
                ...
                if len(sw_p2.get('P_mean_bar', [])) > 0:
                    ...
                    ax_pp.plot(
                        ...
                        sw_p2['P_brake'],
                        color=color,
                        lw=3.2 if gas_name == 'Air' else 2.4,
                        ls='-',
                        marker=markers_gas[gas_name],
                        markevery=4,
                        markersize=5.5 if gas_name == 'Air' else 4.5,
                        zorder=zorder_gas[gas_name],
